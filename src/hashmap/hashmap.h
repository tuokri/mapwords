...
uint64_t
hashmap_hash1(const hashmap_map_t* map, hashmap_key_t key);

uint64_t
hashmap_hash2(const hashmap_map_t* map, hashmap_key_t key);
...
hashmap_map_t*
hashmap_init(
    hash_t (* hashf1)(const char* buffer, size_t size),
    hash_t (* hashf2)(const char* buffer, size_t size));
